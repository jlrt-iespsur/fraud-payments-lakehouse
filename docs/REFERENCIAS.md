...
- Apache Iceberg Structured Streaming: <https://iceberg.apache.org/docs/1.9.2/docs/spark-structured-streaming/>
- Apache Iceberg JDBC catalog: <https://iceberg.apache.org/docs/1.4.3/jdbc/>
...
- MinIO single node container deployment: <https://min.io/docs/minio/container/operations/install-deploy-manage/deploy-minio-single-node-single-drive.html>
- Neo4j Cypher `LOAD CSV`: <https://neo4j.com/docs/cypher-manual/current/clauses/load-csv/>

## Proyectos y demos similares
...
- Kafka UI official repo: <https://github.com/provectus/kafka-ui>
